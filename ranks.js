...
/** Local icons — hosted in assets/ranks/ on GitHub (most reliable) */
const ASSET_BASE = new URL('../assets/ranks/', import.meta.url).href;

/** CDN backup if local file missing (wiki blocks some sites — referrerpolicy helps) */
const RANK_ICON_CDN = {
