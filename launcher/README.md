...
- **v1.1+:** stats scripts are bundled inside the exe — you only need the exe in any folder (plus Node.js). Config files (`grind-config.json`, `bridge.log`) are written next to the exe.
